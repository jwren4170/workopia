<header class="bg-blue-900 p-4 text-white">
    <div class="flex justify-between items-center mx-auto container">
        ...
        <nav class="space-x-4">
            ...
            <a href="post-job.html" class="bg-yellow-500 hover:bg-yellow-600 hover:shadow-md px-4 py-2 rounded text-black transition duration-300"><i class="fa fa-edit"></i> Post a Job</a>
        </nav>
    </div>
</header>