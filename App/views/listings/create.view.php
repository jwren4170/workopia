...
<section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-600 mx-6">
        ...
        <form method="POST" action="/workopia/listings/">
            ...
            <?= load_partial('errors', ['errors' => $errors ?? []]) ?>
            <div class="mb-4">
            ...
            <a href="/workopia/listings" class="block text-center w-full bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded focus:outline-none">
                Cancel
            </a>
        </form>
    </div>
